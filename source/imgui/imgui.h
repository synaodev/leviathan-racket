...
namespace ImGui
{
    ...
    // - The disk functions are automatically called if io.IniFilename != NULL (default is "imgui.cfg").
...
struct ImGuiIO
{
    ...
    const char* IniFilename;                    // = "imgui.cfg"    // Path to .ini file. Set NULL to disable automatic .ini loading/saving, if e.g. you want to manually load/save from memory.
