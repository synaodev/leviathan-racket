...
namespace {
	constexpr sint_t kScreenWidth  = (constants::NormalWidth<sint_t>() / constants::TileSize<sint_t>()) + 1;
	constexpr sint_t kScreenHeight = (constants::NormalHeight<sint_t>() / constants::TileSize<sint_t>()) + 1;
}
