...
public:
	...
	tilemap_layer_t();
	tilemap_layer_t(tilemap_layer_t&& that) noexcept;
	tilemap_layer_t& operator=(tilemap_layer_t&& that) noexcept;
...
public:
	...
	void handle(arch_t range, glm::ivec2 first, glm::ivec2 last, glm::ivec2 map_size, const texture_t* texture);
