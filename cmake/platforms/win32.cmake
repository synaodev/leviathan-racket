...
if (${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
	if (NAOMI_BUILD)
		target_compile_definitions (naomi PRIVATE ${WIN32_GENERAL_DEFS} ${WIN32_CLANG_DEFS})
		if (NOT RTTI_BUILD)
			target_compile_options (naomi PRIVATE "-fno-rtti")
		endif ()
	endif ()
	if (EDITOR_BUILD)
		target_compile_definitions (editor PRIVATE ${WIN32_GENERAL_DEFS} ${WIN32_CLANG_DEFS})
		if (NOT RTTI_BUILD)
...
elseif (MSVC)
	...
	endforeach ()
	if (NAOMI_BUILD)
		target_compile_definitions (naomi PRIVATE ${WIN32_GENERAL_DEFS} ${WIN32_CLANG_DEFS} ${WIN32_MSVC_DEFS})
		if (NOT RTTI_BUILD)
			target_compile_options (naomi PRIVATE "/GR-")
		endif ()
	endif ()
	if (EDITOR_BUILD)
		target_compile_definitions (editor PRIVATE ${WIN32_GENERAL_DEFS} ${WIN32_CLANG_DEFS} ${WIN32_MSVC_DEFS})
		if (NOT RTTI_BUILD)
...
elseif (MINGW)
	...
	if (NAOMI_BUILD)
		target_link_libraries (naomi PRIVATE Threads::Threads)
		target_compile_definitions (naomi PRIVATE ${WIN32_GENERAL_DEFS})
		if (NOT RTTI_BUILD)
			target_compile_options (naomi PRIVATE "-fno-rtti")
		endif ()
	...
	if (EDITOR_BUILD)
		...
		target_compile_definitions (editor PRIVATE ${WIN32_GENERAL_DEFS})
		if (NOT RTTI_BUILD)
			target_compile_options (editor PRIVATE "-fno-rtti")
		endif ()
		if (NOT CMAKE_HOST_WIN32)
